...
$ACCESS_TOKEN = 'rCgMRmAxjQ4V4i7/gSYrz2dMq7pRQ8tK/Ym6ZxqRYWelUxFApkhkfeuen+pPwsKAGSGAV9AX4ruRJPy/Y8+AkbWlT+CWJ3Cxt9zbDLPtUmbKRBxsMVV7uwT2+AoxtFsGtPWIHUvJ2prTyCWwuzP1dgdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
 ...
 foreach ($request_array['events'] as $event)
 {
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
	  ...
	  if($text == "อุณหภูมิตอนนี้" ||$text == "อุณหภูมิ ณ ขณะนี้" ||$text == "อุณหภูมิตอนนี้เท่าไหร่" ||$text == "อุณหภูมิตอนนี้กี่องศา"){
		   $reply_message = '40 องศาเซลเซียส';
	   } 
